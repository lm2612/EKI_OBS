...
function ek_update(iteration_::Int64, N::Int64)
    ...
    last_iteration_parameter_file = "/scratch/users/lauraman/EKI/iteration_$(iteration_)/paramlist.csv"
    ...
    basedir = "/scratch/users/lauraman/EKI/iteration_$(iteration_)/"
...
next_iteration_parameter_file = "/scratch/users/lauraman/EKI/iteration_$(next_iteration_)/paramlist.csv"
